...
def get_args_parser():
    ...
    parser.add_argument('-data_root', type=str, default='../datasets/ORSSD/test/GT')
    parser.add_argument('-pred_root', type=str, default='../output')
    parser.add_argument('--eval_dataset_list', nargs='+', default=['ORSSD'])
    return parser
